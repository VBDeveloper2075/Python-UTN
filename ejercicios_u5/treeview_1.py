...
# ttk da opciones extra de maquetación

# defino la variable global. que por defecto vale 0. y que es autoincremental
mi_id = 0
...
# text variable me permite asociar una variable al campo de entrada (que puede ser un get o set)
...
# Treeview está dentro de master y se pone así
